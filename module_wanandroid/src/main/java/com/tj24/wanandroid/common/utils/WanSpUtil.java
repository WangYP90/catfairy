...
public class WanSpUtil {
    ...
    public static void save(String key, boolean value) {
        SharedPreferences.Editor editor = BaseApplication.getContext().getSharedPreferences(
                Const.MODULE_NAME,BaseApplication.getContext().MODE_PRIVATE).edit();
    ...
    public static boolean read(String key, boolean defValue) {
        SharedPreferences prefs = BaseApplication.getContext().getSharedPreferences(Const.MODULE_NAME,
                BaseApplication.getContext().MODE_PRIVATE);
